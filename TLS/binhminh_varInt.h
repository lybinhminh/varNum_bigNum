...
public:
	...
	varInt operator<<= (size_t);
	varInt operator>>= (size_t);
	varInt barretDivision(varInt*,varInt*);
	varInt& abs();
	static size_t log10(varInt,varInt*);
	static size_t log2(varInt, varInt*);
};
namespace varIntConst {
	extern const varInt ZERO,ONE, TWO, TEN, HEX, BASE;
}
#endif
